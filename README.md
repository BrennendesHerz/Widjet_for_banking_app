...
- функция `filter_by_state` - принимает список словарей, содержащих информацию о транзакциях, и статус операции (опционально). Вывод функции - транзакции с заданным статусом.
Пример входных данных и вызова функции:
```python                                                  
transactions = [
                {
...
- функция `sort_by_date` - принимает список словарей, содержащих информацию о транзакциях, и необязательный параметр, задающий порядок сортировки. Вывод функции - список отсортрованных в заданном порядке словарей.
Пример входных данных и вызова функции:
```python                                                  
transactions = [
                {
